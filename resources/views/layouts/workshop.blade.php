...
<head>
    ...
    <title>@yield('title', 'لوحة تحكم الورشة')</title>
    <!-- Bootstrap RTL -->
    ...
    <style>
        ...
        #sidebar {
            width: 220px;
            min-height: 100vh;
            background: linear-gradient(to bottom, #6610f2, #5a0dc4);
            color: white;
            transition: all 0.3s;
        }
...
<div class="d-flex">
    ...
    <nav id="sidebar" class="position-relative">
        <div class="text-center py-4 fs-4 fw-bold border-bottom border-white">ورشة العمل</div>
        <ul class="nav flex-column mt-3 px-2">
            <li class="nav-item mb-2">
                <a href="{{ route('admin.workshop.index') }}" class="nav-link d-flex align-items-center p-2">
                    <i class="bi bi-house-door-fill"></i><span>لوحة التحكم</span>
                </a>
            </li>
            <li class="nav-item mb-2">
                <a href="#" class="nav-link d-flex align-items-center p-2">
                    <i class="bi bi-bag-fill"></i><span>طلبات قيد التصنيع</span>
                </a>
            </li>
            <li class="nav-item mb-2">
                <a href="#" class="nav-link d-flex align-items-center p-2">
                    <i class="bi bi-check2-square"></i><span>طلبات مكتملة</span>
                </a>
            </li>
            <li class="nav-item">
    ...
    <div class="flex-grow-1">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white shadow-sm px-4">
            <div class="d-flex align-items-center">
                ...
                <span class="fs-5 fw-bold">@yield('page-title', 'لوحة تحكم الورشة')</span>
            </div>
        </nav>
